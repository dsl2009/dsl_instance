...
from layer.vgg16 import SkipVGG16
from layer.renet import ReNet
from layer.instance_counter import InstanceCounter
...
class ReSeg(nn.Module):
    ...
    * Three heads for semantic segmentation, instance segmentation and
    ...
    def __init__(self, n_classes, use_instance_seg=True, pretrained=True,num_filter=10,
...
if __name__ == '__main__':
    ...
    print(md(a)[0].size(),md(a)[1].size(),md(a)[2].size())