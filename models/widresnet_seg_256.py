...
class SegModel(nn.Module):
    def __init__(self):
        ...
        self.final_seg = nn.Conv2d(128, 1, kernel_size=3,padding=1, stride=1, bias=False)

        self.final_instance = nn.Conv2d(128, 16, kernel_size=3, padding=1, stride=1, bias=False)
