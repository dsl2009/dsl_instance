...
from torch.nn import Conv2d,GroupNorm,BatchNorm2d
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, dilation=1):
        ...
        self.conv2 = Conv(planes, planes, kernel_size=3, stride=stride, dilation=dilation,
...
class ResNet(nn.Module):
    def __init__(self, block, layers=(3, 4, 23, 3)):
        ...
        self.layer4 = self._make_MG_unit(block, 512, blocks, stride=1,dilation=4)
